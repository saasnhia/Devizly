...
const comparisonFeatures: PlanFeature[] = [
  ...
  { text: "Partage par lien", free: true, pro: true, business: true },
  { text: "WhatsApp / Email / SMS", free: false, pro: true, business: true },
...
const faqs = [
  ...
  },
  {
    ...
    a: "Le plan Free est gratuit pour toujours, sans carte bancaire. Pour les plans payants, vous pouvez annuler à tout moment.",
  },
  {
